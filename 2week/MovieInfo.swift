...
struct MovieInfo {
    ...
    var movies: [Movie] = [
        ...
        Movie(title: "어벤져스엔드게임", releaseDate: "2019.04.24.", runtime: 181, overview: "인피니티 워 이후 절반만 살아남은 지구 마지막 희망이 된 어벤져스 먼저 떠난 그들을 위해 모든 것을 걸었다! 위대한 어벤져스 운명을 바꿀 최후의 전쟁이 펼쳐진다!", rate: 9.49, isLiked: true, backgroundColor: generateColor()),
        ...
        Movie(title: "캐치미 이프유캔", releaseDate: "2002.09.11.", runtime: 134, overview: "신이 내린 축복을 찾기 위해 여행을 떠나는 소년의 성장 이야기.", rate: 8.10, isLiked: false, backgroundColor: generateColor()),
